...
class Customer:
    ...
    def calculate_trip_cost(self, shop_location: list[int], car: "Car") -> float:
        print("Customer location:", self.location)
        print("Shop location:", shop_location)
        distance = round(math.sqrt((self.location[0] - shop_location[0]) ** 2
                                   + (self.location[1] - shop_location[1]) ** 2), 2)
